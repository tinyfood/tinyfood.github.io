  ...
  <div class="navarea">
    <nav>
      <div class="capsule">
              ...
              <div class="capsule" style="width:140px; top:7px;position:relative;"><h6>Farm to consumer <a href="/knowledgebase" alt="Tiny Food hyper-local food production, transportation and distribution Knowledgebase by SCD Hub">knowledgebase</a> & buyer hub</h6></div>
        <ul>
